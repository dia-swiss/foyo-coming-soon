const Datenschutz = () => {
    ...
    return <div className='max-w-4xl'>
        <div className='font-semibold text-xl py-2'>Datenschutzerklärung</div>
        ...
        <div>Dominik Gebhardt</div>
        <div>Gellerststrasse 24</div>
        <div>4052 Basel</div>
        <br />
        <div>Telefon: +41 52 229 51 55</div>
        <div>E-Mail: dominik.gebhardt@dia.swiss</div>
        <div>Website: https://qoyo.io/</div>
        <br />

        <div className='font-semibold text-xl py-2'>Allgemeiner Hinweis</div>
        ...
        <br />
        <div className='font-semibold text-xl py-2'>Google Tag Manager</div>
        <p>Google Tag Manager ist eine Lösung, mit der wir sog. Website-Tags über eine Oberfläche verwalten können und so z.B. Google Analytics sowie andere Google-Marketing-Dienste in unser Onlineangebot einbinden können. Der Tag Manager selbst, welcher die Tags implementiert, verarbeitet keine personenbezogenen Daten der Nutzer. Im Hinblick auf die Verarbeitung der personenbezogenen Daten der Nutzer wird auf die folgenden Angaben zu den Google-Diensten verwiesen. Nutzungsrichtlinien: <a href='https://www.google.com/intl/de/tagmanager/use-policy.html' target="_blank" rel="noopener noreferrer">Google Tag Manager</a></p>
        <br />
